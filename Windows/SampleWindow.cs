...
public class SampleWindow : Window, IDisposable
{
    ...
    public SampleWindow(Plugin plugin, string goatImagePath)
        : base("Foilwalker Tracker##FWTracker", ImGuiWindowFlags.NoScrollbar | ImGuiWindowFlags.NoScrollWithMouse)
    {
